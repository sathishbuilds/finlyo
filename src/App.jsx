...
const SECONDARY_TABS=["Overview","Rates","Tools"];
...
const LIGHT={bg:"#F0F4F8",white:"#FFFFFF",card:"#FFFFFF",input:"#F0F4F8",border:"#E2E8F0",borderMid:"#CBD5E1",ink:"#0A1628",inkMid:"#3D4F6B",inkLo:"#7A90A8",blue:"#1D4ED8",blueSoft:"#EEF2FF",blueMid:"#3B6FDB",green:"#047857",greenSoft:"#ECFDF5",red:"#B91C1C",redSoft:"#FEF2F2",amber:"#B45309",amberSoft:"#FFFBEB",steel:"#475569"};
const DARK={bg:"#060D18",white:"#0F1C2E",card:"#0F1C2E",input:"#0A1628",border:"#1E3148",borderMid:"#2A4060",ink:"#E8F0FE",inkMid:"#8BA3C0",inkLo:"#4A6080",blue:"#4D8FF7",blueSoft:"#0F2447",blueMid:"#6BA3F8",green:"#10B981",greenSoft:"#062918",red:"#F87171",redSoft:"#2D0F0F",amber:"#FBBF24",amberSoft:"#1A1000",steel:"#6B8CAE"};
...
function Finlyo({user,darkMode,onOpenSettings}){
  ...
  const css="@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&family=DM+Mono:wght@300;400;500&display=swap');"
    +"*{box-sizing:border-box;margin:0;padding:0;} body{background:"+C.bg+";} .num{font-family:'Plus Jakarta Sans',sans-serif;font-feature-settings:'tnum' 1,'zero' 0;font-variant-numeric:tabular-nums;}"
    ...
    <div style={{background:C.bg,minHeight:"100vh",fontFamily:"'Plus Jakarta Sans','Inter',sans-serif",color:C.ink,overflowX:"hidden",maxWidth:"100vw"}}>
      ...
      <main style={{padding:"14px 13px 56px",maxWidth:"640px",margin:"0 auto"}} onClick={()=>{showCur&&setShowCur(false);showMore&&setShowMore(false);}}>
                  ...
                  <PieChart>
                    <Pie data={pieData} cx="50%" cy="50%" innerRadius={46} outerRadius={70} dataKey="value" paddingAngle={3}
                      label={({cx,cy,midAngle,outerRadius,percent,name})=>{
                        ...
                        return<text x={x} y={y} fill={darkMode?"#CBD5E1":"#475569"} textAnchor={x>cx?"start":"end"} dominantBaseline="central" fontSize="10" fontWeight="600">{(percent*100).toFixed(0)}%</text>;
                      }}
                      labelLine={false}>
        ...
        {tab==="Tools"&&<div className="fade">
          <div style={{marginBottom:"14px"}}><h2 style={{fontSize:"18px",fontWeight:"800",color:C.ink,letterSpacing:"-.4px"}}>Tools</h2><p style={{fontSize:"11px",color:C.inkLo,marginTop:"2px"}}>EMI Calculator · Rates comparison.</p></div>
