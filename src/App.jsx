        ...
        {tab==="Budget"&&<div className="fade">
          ...
          {md.income>0&&insights.length>0&&(
            <div style={{background:C.white,border:"1px solid "+C.border,borderRadius:"13px",padding:"13px 15px",marginBottom:"10px",display:"flex",alignItems:"flex-start",gap:"10px"}}>
              <div style={{width:"32px",height:"32px",borderRadius:"10px",background:insights[0].type==="positive"?C.greenSoft:insights[0].type==="warning"?C.amberSoft:C.blueSoft,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,fontSize:"14px"}}>{insights[0].icon}</div>
              <div style={{flex:1,minWidth:0}}>
                <div style={{fontSize:"10px",color:C.inkLo,fontFamily:"'DM Mono',monospace",letterSpacing:"1px",marginBottom:"3px"}}>THIS MONTH</div>
                <div style={{fontSize:"13px",fontWeight:"600",color:C.ink,lineHeight:1.4}}>{insights[0].text}</div>
              </div>
            </div>
          )}
